/**
 *
 * $Id: PrimitiveP.h,v 1.2 1997/11/07 22:27:42 rwscott Exp $
 *
...
extern void _XmPrimitiveHighlightThicknessDefault(Widget w, int offset, XrmValue *val);
extern void _XmPrimitiveShadowThicknessDefault(Widget w, int offset, XrmValue *val);
