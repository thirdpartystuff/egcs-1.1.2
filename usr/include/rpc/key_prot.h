...
extern bool_t xdr_keystatus   __P (( XDR *, keystatus * ));


typedef char keybuf[HEXKEYBYTES];
extern bool_t xdr_keybuf      __P (( XDR *, keybuf ));


typedef char *netnamestr;
extern bool_t xdr_netnamestr  __P (( XDR *, netnamestr * ));
...
extern bool_t xdr_cryptkeyarg __P (( XDR *, cryptkeyarg * ));
...
extern  bool_t xdr_cryptkeyarg2 __P (( XDR *, cryptkeyarg2 * ));
...
extern bool_t xdr_cryptkeyres __P (( XDR *, cryptkeyres * ));
...
extern bool_t xdr_unixcred    __P (( XDR *, unixcred * ));
...
#else /* Old Style C */ 
extern bool_t xdr_getcredres  __P (( XDR *, getcredres * ));
#endif /* Old Style C */ 
