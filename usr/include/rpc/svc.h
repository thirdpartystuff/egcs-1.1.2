...
typedef struct SVCXPRT {
	...
	struct xp_ops {
	    ...
	    bool_t            (*xp_recv)      __P (( struct SVCXPRT *,
                                                struct rpc_msg * ));
         /* get transport status */
	    enum xprt_stat    (*xp_stat)      __P (( struct SVCXPRT * ));
         /* get arguments */
	    bool_t            (*xp_getargs)   __P (( struct SVCXPRT *,
                                              xdrproc_t, caddr_t ));
         /* send reply */
	    bool_t            (*xp_reply)     __P (( struct SVCXPRT *,
                                                struct rpc_msg * ));
         /* free mem allocated for args */
	    bool_t            (*xp_freeargs)  __P (( struct SVCXPRT *,
                                             xdrproc_t, caddr_t ));
         /* destroy this struct */
 ...
 */
/* This version of 'svc_register' created much problems when
 * prototyping 'svc.c'.  vch
 * extern bool_t svc_register __P ((SVCXPRT *__xpr, u_long __prog,
 *		u_long __vers, __dispatch_fn_t __dispatch, u_long __protocol));
 */
extern bool_t svc_register __P ((SVCXPRT *__xpr, u_long __prog,
		u_long __vers, void (*dispatch), u_long __protocol));
...
extern bool_t  svc_sendreply    __P ((SVCXPRT *__xprt, xdrproc_t __xdr_results,
